...
public class SportController {
	...
	@PostMapping("/sports")
	public Sport createSport(@Validated @RequestBody Sport sport) {
	...
	public ResponseEntity<Sport> updateSport(@PathVariable(value = "id") long sportId, @RequestBody Sport sportDetails)
			throws ResourceNotFoundException {
		Sport sport = sportRepository.findById(sportId)
				.orElseThrow(() -> new ResourceNotFoundException("Sport not found for this id : " + sportId));
